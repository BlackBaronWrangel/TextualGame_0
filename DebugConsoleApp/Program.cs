...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        _stateMachine.NextState(_stateMachine.CurrentState!.BaseEvent.PossibleNextEvents.Values.ToList()[0]);
        _stateMachine.NextState(_stateMachine.CurrentState!.BaseEvent.PossibleNextEvents.Values.ToList()[1]);
